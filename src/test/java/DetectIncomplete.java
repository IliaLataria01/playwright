...
public class DetectIncomplete {
    ...
    @Test
    public void detectIncompleteOfSpecificPage() {
    ...
    private static void outputAccessibilityResults(AxeResults accessibilityScanResults) {
        if (accessibilityScanResults.getViolations().isEmpty()) {
            System.out.println("No accessibility Incomplete found.");
        } else {
            System.out.println("Accessibility Incomplete found:");
            FileUtils.writeToFile("src/test/resources/single_violations/accessibility_errors.json",accessibilityScanResults.getIncomplete());
        }
    }
}
